...
class AnnotationInteractorStyle(vtk.vtkInteractorStyleTrackballCamera):
    ...
    def left_button_press_event(self, obj, event):
        if not window.annotation_button.isChecked():
    ...
    def add_annotation(self, position):
        annotation_text = window.annotation_text_edit.toPlainText()
        ...
        if annotation_text:
            ...
            window.annotation_text_edit.clear()
...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.annotation_interactor_style = AnnotationInteractorStyle(self.vtk_widget)
